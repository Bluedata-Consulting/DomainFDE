...
from . import release
from .data import complaint_view
from .guardrail import before_tool_callback as guardrail
...
def before_tool_callback(tool, args, tool_context):
    ...
    if status == "blocked":
        ...
        if tool.name in ("escalate_to_human", "request_approval"):
