...
from .decision_tree import check_complaint
from .guardrails import before_tool_callback as guardrail
from .tools import COMPLAINTS
...
def before_tool_callback(tool, args, tool_context):
    ...
    if tool.name == "get_complaint" and complaint_id in COMPLAINTS:
        at_risk = check_complaint(COMPLAINTS[complaint_id]) is not None
        _write(tool_context, "lookup", complaint_id=complaint_id, at_risk=at_risk)
