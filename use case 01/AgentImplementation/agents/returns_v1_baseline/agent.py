"""Returns disposition agent, VERSION 1 (pre-ADLC baseline).
...
# update_return_record can even rewrite an inspector's grade. Note that while
# you test.
root_agent = Agent(
    name="returns_v1_baseline",
