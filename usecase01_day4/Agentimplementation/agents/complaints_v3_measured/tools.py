"""Tools for the complaint agent, version 3.

Unchanged from version 2: the Day 1 data and tools, plus escalate_to_human, which
records every handover in escalations.log so a person can see it.
...
# The human queue. One line per escalation, kept after the server stops.
...
def escalate_to_human(complaint_id: str, owner: str, reason: str) -> dict:
    """Hand a complaint to a named person, with the reason."""
