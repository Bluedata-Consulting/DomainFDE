"""Guardrail: connects the decision tree to the ADK agent (unchanged from Day 2, except
that it looks complaints up through the ontology, so rules see the customer behind them).
...
from .tools import escalate_to_human, get_complaint
...
def before_tool_callback(tool, args, tool_context):
    ...
    complaint = complaint_view(complaint_id)
