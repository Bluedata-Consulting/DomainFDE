"""Tools for the complaint agent, version 2.

Same data and tools as version 1, plus escalate_to_human, which records every
handover in escalations.log so a person can see it.
